                ...
                <div style="margin-bottom: 30px">
                    <table border="0" id="tblClients" rules="cols" frame="box" class="sortable">
                        <tr>
                            ...
                            <th align="left" style="width:30%">Mobile</th>
                            <th align="left" style="width:30%">Date Modified</th>
                    ...
                    <form name="frmClients" action="clients.php" method="post" id="frmClients">
                        <table style="width:100%">
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" colspan="2" style="width: 50%">
                                    <input style="width: 100%" id="fldEmail1" name="fldEmail1" type="text" size="20" placeholder="EMAIL,REQUIRED" maxlength="<?php echo AT_MAXEMAIL; ?>" value="<?php echo SharedPrepareDisplayString($fldemail1); ?>" required pattern="^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" title="Invalid Email address"/>
