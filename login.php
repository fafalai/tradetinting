						...
						<table align="left" style="width:85%">
							<tr>
								...
								<td align="left" valign="top" style="width:100%">
									<input id="fldUid" name="fldUid" placeholder="USERNAME" type="text"
										maxlength="<?php echo AT_MAXNAME; ?>" />
							...
							<tr>
								...
								<td align="left" valign="top" style="width:100%">
									<input id="fldPwd" name="fldPwd" placeholder="PASSWORD" type="password"
										class="loginInput" maxlength="<?php echo AT_MAXPWD; ?>" style="width:100%" />
							...
							<td align="left" valign="top">
								<div id="DIV_Message">
									<p>
										<a href="signup.php">Click here</a> to sign up today for your <font color='red'>FREE</font> 30 Day trial or  <a href="contact.php">Click here</a> to message us.
									</p>
								</div>
								</td>
							</tr>
