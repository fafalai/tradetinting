    ...
    <div id="content">
      <div id="content-bgtop">
        <div id="content-bgbtm">
          ...
          <div class="post">
            <p class="meta"><span class="date"><?php if ($usermsg != "") echo $usermsg; else echo date("l, F j, Y"); ?></span></p>
            <h2 class="title">Add/Modify Users</h2>
            <div class="entry">
                  ...
                  <form action="users.php" method="post" id="frmUsers">
                    <table>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"><input id="fldName" name="fldName" type="text" size="20" maxlength="<?php echo AT_MAXNAME; ?>" value="<?php echo SharedPrepareDisplayString($fldname); ?>"  /><div id="frmUsers_fldName_errorloc" class="error_strings"></div></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top">User ID:</td>
                        <td align="left" valign="top"><input id="fldUid" name="fldUid" type="text" size="20" maxlength="<?php echo AT_MAXNAME; ?>" value="<?php echo SharedPrepareDisplayString($flduid); ?>" onchange="CheckUserId();" /><div id="frmUsers_fldUid_errorloc" class="error_strings"></div></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top">Password:</td>
                        <td align="left" valign="top"><input id="fldPwd" name="fldPwd" type="password" size="20" maxlength="<?php echo AT_MAXPWD; ?>" /><div id="frmUsers_fldPwd_errorloc" class="error_strings"></div></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top">Confirm:</td>
                        <td align="left" valign="top"><input id="fldConfirmPwd" name="fldConfirmPwd" type="password" size="20" maxlength="<?php echo AT_MAXPWD; ?>" /><div id="frmUsers_fldConfirmPwd_errorloc" class="error_strings"></div></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top">Email:</td>
                        <td align="left" valign="top"><input id="fldEmail" name="fldEmail" type="text" size="20" maxlength="<?php echo AT_MAXEMAIL; ?>" value="<?php echo SharedPrepareDisplayString($fldemail); ?>" /><div id="frmUsers_fldEmail_errorloc" class="error_strings"></div></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top">Mobile:</td>
                        <td align="left" valign="top"><input id="fldMobile" name="fldMobile" type="text" size="20" maxlength="<?php echo AT_MAXPHONE; ?>" value="<?php echo SharedPrepareDisplayString($fldmobile); ?>" /><div id="frmUsers_fldMobile_errorloc" class="error_strings"></div></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top">&nbsp;</td>
              ...
              ?>
                  <form action="users.php" method="post" id="frmUsers">
                    <table>
                      ...
                      <tr>
                        <td align="left" valign="top">Name:</td>
                        <td align="left" valign="top"><input id="fldModName" name="fldModName" type="text" size="20" maxlength="50" class="required" value="<?php echo SharedPrepareDisplayString($fldname); ?>" /><div id="frmUsers_fldModName_errorloc" class="error_strings"></div></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top">Email:</td>
                        <td align="left" valign="top"><input id="fldModEmail" name="fldModEmail" type="text" size="20" maxlength="<?php echo AT_MAXEMAIL; ?>" value="<?php echo SharedPrepareDisplayString($fldemail); ?>" /><div id="frmUsers_fldModEmail_errorloc" class="error_strings"></div></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top">Mobile:</td>
                        <td align="left" valign="top"><input id="fldModMobile" name="fldModMobile" type="text" size="20" maxlength="<?php echo AT_MAXPHONE; ?>" value="<?php echo SharedPrepareDisplayString($fldmobile); ?>" /><div id="frmUsers_fldModMobile_errorloc" class="error_strings"></div></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top">&nbsp;</td>
                  ...
                  <form action="users.php" method="post" id="frmPwd">
                    <table>
                      ...
                      <tr>
                        <td align="left" valign="top">Password:</td>
                        <td align="left" valign="top"><input id="fldPwd" name="fldPwd" type="password" size="20" maxlength="50" class="required validate-password" /></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top">Confirm:</td>
                        <td align="left" valign="top"><input id="fldConfirmPwd" name="fldConfirmPwd" type="password" size="20" maxlength="50" class="required validate-confirm" /></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top">&nbsp;</td>
          ...
          <div class="post">
            ...
            <h2 class="title">Existing Users</h2>
            <div class="entry">
